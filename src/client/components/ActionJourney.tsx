...
export function ActionJourney({ reportId, capabilities, classification, entities = [] }: { reportId: string; capabilities: CapabilityResult[]; classification?: ClassificationResult; entities?: SiteEntity[] }) {
